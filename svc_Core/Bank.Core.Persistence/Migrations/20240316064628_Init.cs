...
public partial class Init : Migration
{
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                BalanceChange_CreditPayment_CreditId = table.Column<Guid>(
                    type: "uuid",
                    nullable: true
                ),
                ...
                Transfer_Source_CreditPayment_CreditId = table.Column<Guid>(
                    type: "uuid",
                    nullable: true
                ),
                ...
                Transfer_Target_CreditPayment_CreditId = table.Column<Guid>(
                    type: "uuid",
                    nullable: true
                ),
    ...
    {
        migrationBuilder.DropTable(name: "AccountEvent");
