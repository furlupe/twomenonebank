...
public partial class AddCurrencies : Migration
{
    ...
    {
        migrationBuilder.DropColumn(name: "Balance", table: "Accounts");

        migrationBuilder.DropColumn(name: "BalanceChange_Value", table: "AccountEvent");

        migrationBuilder.DropColumn(name: "Transfer_Source_Value", table: "AccountEvent");

        migrationBuilder.DropColumn(name: "Transfer_Target_Value", table: "AccountEvent");
    ...
    {
        migrationBuilder.DropColumn(name: "Balance_Amount", table: "Accounts");

        migrationBuilder.DropColumn(name: "Balance_Currency", table: "Accounts");
