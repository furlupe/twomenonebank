...
public partial class AddTransfers : Migration
{
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.DropIndex(name: "IX_AccountEvent_AccountId", table: "AccountEvent");

        migrationBuilder.DropColumn(name: "AccountId", table: "AccountEvent");

        migrationBuilder.DropColumn(name: "Transfer_Id", table: "AccountEvent");
    ...
    {
        migrationBuilder.DropTable(name: "AccountAccountEvent");

        migrationBuilder.DropColumn(name: "Transfer_Type", table: "AccountEvent");
